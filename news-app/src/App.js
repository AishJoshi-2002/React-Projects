      ...
      <div>
        <Router>
          ...
          <Routes>
            ...
            <Route exact path='/business' element={<News setProgress={this.setProgress} key="buisness" apiKey={this.apiKey} pageSize={this.pageSize} country="in" category='buisness' />} />
